...
export function NextActions() {
  ...
  return (
    <div className="flex flex-col h-full p-6 gap-6">
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Select
                  value={actionContext}
                  onValueChange={(v) => setActionContext(v as Context)}
                >
                  <SelectTrigger>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setActionProjectId(v === 'none' ? null : v)
                  }
                >
                  <SelectTrigger>
      ...
      <Tabs
        value={activeContext}
        onValueChange={(v) => setActiveContext(v as Context | 'all')}
      >
        <TabsList className="w-full justify-start overflow-auto">
          ...
          {CONTEXTS.map((ctx) => {
            const count = actions.filter(
              (a) => !a.completed && a.context === ctx.value,
            ).length
            return (
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg">
                  {activeContext === 'all'
                    ? 'All Actions'
                    : getContextInfo(activeContext as Context).label}
                </CardTitle>
                <Button
                  variant="ghost"
                  size="sm"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p
                              className={`font-medium ${action.completed ? 'line-through' : ''}`}
                            >
                              {action.content}
                            </p>
