...
import { CONTEXTS, SOMEDAY_CATEGORIES, type Context, type SomedayCategory } from '@/types/gtd';
import { Plus, Trash2, ArrowRight, Clock, Lightbulb, ListTodo, Users, FolderKanban } from 'lucide-react';
...
export function Inbox() {
    ...
    const [processStep, setProcessStep] = useState<'actionable' | 'two-minute' | 'organize'>('actionable');
    const [selectedContext, setSelectedContext] = useState<Context>('@anywhere');
    const [selectedCategory, setSelectedCategory] = useState<SomedayCategory>('other');
            ...
            <Dialog open={processDialogOpen} onOpenChange={setProcessDialogOpen}>
                <DialogContent className="max-w-lg">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        <Select value={selectedCategory} onValueChange={(v) => setSelectedCategory(v as SomedayCategory)}>
                    ...
                    {processStep === 'two-minute' && (
                        <div className="space-y-4">
                            <p className="font-medium">Can you do it in less than 2 minutes?</p>
                            <div className="grid grid-cols-2 gap-3">
                                <Button
                                    className="h-24 flex-col gap-2"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex gap-2 items-center">
                                    <Select value={selectedContext} onValueChange={(v) => setSelectedContext(v as Context)}>
                                        <SelectTrigger className="flex-1">
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
