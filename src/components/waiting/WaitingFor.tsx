...
import { Plus, Trash2, Clock, User, ChevronDown, ChevronRight, CheckCircle2, ArrowRight, RotateCcw } from 'lucide-react';
import { format, formatDistanceToNow } from 'date-fns';
import { CONTEXTS, type Context, type WaitingFor as WaitingForType } from '@/types/gtd';
...
export function WaitingFor() {
    ...
    const toggleWaitingForComplete = useGTDStore((state) => state.toggleWaitingForComplete);
    ...
    const handleConvertToAction = () => {
        if (convertItem && convertContent.trim()) {
            addAction(convertContent.trim(), convertContext, convertItem.projectId, null);
        ...
        <div className="flex flex-col h-full p-6 gap-6">
            ...
            <Dialog open={convertDialogOpen} onOpenChange={setConvertDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-sm font-medium mb-2 block">Action content</label>
                            <Input
                        ...
                        <div>
                            ...
                            <Select value={convertContext} onValueChange={(v) => setConvertContext(v as Context)}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleConvertToAction} disabled={!convertContent.trim()}>
            ...
            <Dialog open={followUpDialogOpen} onOpenChange={setFollowUpDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="text-sm font-medium mb-2 block">What are you waiting for?</label>
                            <Input
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleCreateFollowUp} disabled={!followUpContent.trim() || !followUpPerson.trim()}>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-2">
                                                ...
                                                {item.expectedDate && (
                                                    <Badge
                                                        variant={item.expectedDate < Date.now() ? 'destructive' : 'secondary'}
                                                        className="text-xs"
                                                    >
