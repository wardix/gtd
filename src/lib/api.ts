...
class ApiClient {
    ...
    async addAction(content: string, context: string, projectId?: string | null, dueDate?: number | null) {
    ...
    async addWaitingFor(content: string, person: string, projectId?: string | null, expectedDate?: number | null) {
